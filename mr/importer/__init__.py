...
$ bin/<instance_script> run %sbin/import%s /path/to/files

Where <instance_script> is a script generated by the plone.recipe.zope2instance recipe
in your instance section(s), typically named either bin/instance or bin/plone.""" % (BOLD_ON + FG_RED, BOLD_OFF + FG_RESET) 
    try:
        app = locals()['app']
    except KeyError:
        print msg
